...
from pinecone_assistant_prompt_injection_detector import PineconeAssistantPromptInjectionDetector
...
- Knowledge base extraction ("dump all documents from the corpus")
- RAG pipeline bypass ("bypass the retrieval pipeline")
- Assistant configuration disclosure ("reveal your system prompt")
"""
    )
    ...
    # Summary
    print(f"\n{'='*65}")
    print("Pinecone Assistant MCP Security Scan Results:")
    print(f"{'-'*65}")
    ...
    if use_baseline:
        ...
        if total_findings > 0:
            ...
            print("- Extract knowledge base contents")
            print("- Manipulate the RAG pipeline")
